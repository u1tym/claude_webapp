...
const NAV_ITEMS: { key: NavKey; label: string; path: string }[] = [
  { key: "videos", label: "動画", path: "/" },
  { key: "playlists", label: "プレイリスト", path: "/playlists" },
  { key: "history", label: "履歴", path: "/history" },
  { key: "series", label: "作品", path: "/series" },
  { key: "genres", label: "ジャンル", path: "/genres" },
];
