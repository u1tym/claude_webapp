...
<template>
  ...
  <div v-else-if="settings" class="shell">
    ...
    <nav class="nav" aria-label="ナビ">
      <div class="nav-brand pc-only">パスワード管理</div>
      <button class="nav-item is-current" type="button">パスワード管理</button>
    </nav>
    <main class="content">
      <RouterView />
    </main>
