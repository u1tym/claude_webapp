...
const title = computed(() => {
  ...
  return typeof value === "string" ? value : "家計管理";
});
...
<template>
  <div class="shell">
    ...
    <nav class="nav">
      <router-link to="/">支出記録</router-link>
      <router-link to="/budgets">予算管理</router-link>
      <router-link to="/payment-methods">支出方法管理</router-link>
      <router-link to="/reports">集計</router-link>
    </nav>
    <main class="content">
